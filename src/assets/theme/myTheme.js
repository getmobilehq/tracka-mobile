const myTheme = {
  ...
  badge: {
    ...
    success: "text-blue-500 bg-blue-100 dark:bg-blue-800 dark:text-blue-100",
  ...
  button: {
    ...
    outline: {
      ...
      active:
        "active:bg-transparent hover:border-gray-300 focus:border-gray-300 active:text-gray-500 focus:ring focus:ring-gray-300",
